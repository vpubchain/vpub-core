...
def setup():
    ...
    if not os.path.isdir('particl-core'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vpubchain/particl-core.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/vpubchain/particl-core', help='Specify the URL of the repository. Default is %(default)s')
